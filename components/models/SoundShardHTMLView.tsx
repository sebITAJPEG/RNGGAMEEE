...
export const SoundShardHTMLView = () => {
...
<body>
    ...
    <div id="controls">
        <div id="restart-btn" class="hud-btn" title="Re-Sync Sequence">⟳</div>
    ...
    <script type="module">
        ...
        const startCamPos = new THREE.Vector3(0, 30, 0);
        ...
        function animate() {
            ...
            // ANIMATION LOGIC (Only if visible)
            if (shards[0].root.visible) {
                // Background
                ...
                shards.forEach((shard, index) => {
                    // Expand from 0 scale during cutscene
                    if(inCutscene && cutsceneTime > 3.0) {
                        const sScale = Math.min((cutsceneTime - 3.0), 1.0);
                        shard.root.scale.setScalar(sScale * (index === 0 ? 1.0 : 0.25));
                    }
