...
export const HypercubeFragmentHTMLView = () => {
...
<body>
    ...
    <div id="controls">
        <div id="restart-btn" class="hud-btn" title="Re-Initialize Sequence">⟳</div>
    ...
    <script type="module">
        ...
        // Initial Cutscene Position
        const defaultPos = new THREE.Vector3(0, 0, 11);
        const startPos = new THREE.Vector3(0, 0, 3.5); // Close to rock
        ...
        controls.enabled = false; // Disabled during cutscene
        ...
        function playRiser() {
            ...
            // Increasing tension oscillator
            const osc = audioContext.createOscillator();
            osc.type = 'sawtooth';
            osc.frequency.setValueAtTime(50, now);
            osc.frequency.exponentialRampToValueAtTime(400, now + 3.0); // Rise
            
            const gain = audioContext.createGain();
            gain.gain.setValueAtTime(0, now);
            gain.gain.linearRampToValueAtTime(0.15, now + 3.0); // Fade in
            gain.gain.linearRampToValueAtTime(0, now + 3.1); // Cut
        ...
        function animate() {
            ...
            rock.rotation.x = Math.sin(time * 0.1) * 0.15 + (inCutscene ? Math.random() * shakeIntensity : 0);
